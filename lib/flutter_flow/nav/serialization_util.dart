  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case TbFotosRow:
            return TbFotosRow(data);
          case ImagemRow:
            return ImagemRow(data);
          case CodigoRow:
            return CodigoRow(data);
          case PastahRow:
            return PastahRow(data);
          case TabelaFotosRow:
            return TabelaFotosRow(data);
          case CuponsRow:
            return CuponsRow(data);
          case ProdutosRow:
          ...
          case CoresRow:
            return CoresRow(data);
          case UseripRow:
            return UseripRow(data);
          default:
            return null;
        }
